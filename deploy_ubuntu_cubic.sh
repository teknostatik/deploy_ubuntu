...
sudo apt install -y i3 i3blocks feh arandr git curl byobu synaptic xautolock shellcheck barrier kitty zathura pcmanfm featherpad qutebrowser xinit network-manager lxde zsh hexchat
